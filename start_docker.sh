...
docker run -dit --restart unless-stopped --name politiquices-api --net politiquices --env SPARQL_ENDPOINT=$PROTOCOL_IP -p 127.0.0.1:8000:8000  -v .:/app politiquices-api
